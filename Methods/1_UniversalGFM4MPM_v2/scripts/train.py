...
def main() -> None:
    ...
    if args.train_dcca:
        ...
        if use_transformer_agg and target_stack_per_anchor:
            ...
            agg_hidden_dim = max(1, int(agg_hidden_dim))
            ...
            if agg_hidden_dim % agg_num_heads != 0:
                agg_hidden_dim = agg_num_heads * max(1, math.ceil(agg_hidden_dim / agg_num_heads))
            ...
            try:
                ...
                print(agg_hidden_dim, agg_num_layers, agg_num_heads, agg_steps, agg_dropout, agg_batch_size, drop_ratio, dcca_eps_value)
                exit()
...
def _train_transformer_aggregator(
    ...
    *,
    ...
    proj_anchor = ProjectionHead(anchor_dim, agg_dim, num_layers=2).to(device)
    proj_target = ProjectionHead(agg_dim, agg_dim, num_layers=2).to(device)
